...
document.addEventListener('DOMContentLoaded', function() {
      ...
      if (!window.zappyContactFormLoaded) {
        ...
        try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: 'a85a5a25-0abb-416b-bf27-2695974b1ce0',
              name: formData.name,
  ...
  const fadeElements = document.querySelectorAll('.category-card, .feature-box, .value-card');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "That's Why we Clash משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
